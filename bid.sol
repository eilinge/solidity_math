...
contract SimpleAuction {
    // 拍卖的参数。
    address public beneficiary;//参与
    // 时间是unix的绝对时间戳（自1970-01-01以来的秒数）
    // 或以秒为单位的时间段。
    uint public auctionEnd;

    // 拍卖的当前状态
    address public highestBidder;//物品的拥有者
    uint public highestBid;//当前价格
    ...
    // 变更触发的事件
    event HighestBidIncreased(address bidder, uint amount);//最高价格产生
    event AuctionEnded(address winner, uint amount);//竞拍结束
